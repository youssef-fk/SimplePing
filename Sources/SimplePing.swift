...
fileprivate func SocketReadCallback(socket: CFSocket?,
...
func hostStringWithData(_ data: Data) -> String {
...
class SimplePing: Ping {
    enum AddressStyle: Int {
        case any
        case icmpv4
        case icmpv6
    }
    ...
    fileprivate func didFailWithHostStreamError(_ error: CFStreamError) {
    ...
    private func startwithHostAddress() {
        ...
        self.delegate?.pinger(self, didStartWithAddress: hostAddress)
    }
    
    fileprivate func hostResolutionDone(_ host: CFHost) {
